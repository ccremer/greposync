...
/*
This file is mostly copied from https://github.com/helm/helm/blob/ae8e88e0d93e2f0c0edc4521db18774ada6334bd/pkg/engine/funcs_test.go.
*/
...
func TestFuncs(t *testing.T) {
	...
	for _, tt := range tests {
		...
		err := template.Must(template.New("test").Funcs(GoTemplateFuncMap()).Parse(tt.tpl)).Execute(&b, tt.vars)
