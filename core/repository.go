...
type GitRepository interface {
	...
	GetLabels() []Label
	// GetConfig returns the GitRepositoryProperties instance associated for this particular repository.
	GetConfig() GitRepositoryProperties
...
type GitRepositoryProperties struct {
