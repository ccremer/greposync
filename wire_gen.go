...
func initInjector() *injector {
	...
	updateAppService := update.NewConfigurator(goTemplateEngine, repositoryStore, goTemplateStore, koanfValueStore, pullRequestStore, renderService, cleanupService, consoleDiffPrinter, configuration, coloredConsole)
