...
func initInjector() *injector {
	...
	mapStore := valuestore.NewMapStore(valueStoreInstrumentation)
	...
	updateAppService := update.NewConfigurator(goTemplateEngine, repositoryStore, goTemplateStore, mapStore, pullRequestStore, renderService, cleanupService, pullRequestService, consoleDiffPrinter, configuration, coloredConsole)
